...
public class SysLoginController extends BaseController
{
    ...
    @PostMapping("/loginmys")
    @ResponseBody
    public AjaxResult loginmys(String username, String password, Boolean rememberMe)
    {
        ...
        if(boo==true){
            JSONObject jsonObject = ZPTinterface.getUserinfo(password);
            String resultCode = jsonObject.getString("code");//0000
            if(resultCode.equals("2000")) {//用户存在，考勤中增加新用户
